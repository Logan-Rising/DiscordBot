...
module.exports = {
    ...
    syntax:
        ...
        'See this link to language codes for another language not listed here: ' +
    ...
    async execute(client, message, args, Discord, firedb) {
        ...
        if (!name && !abbr) {
            messages.send_reply(
                firedb,
                message,
                'Language not recognized. Use &help translate for help with this command'
            );
            return;
        }
        ...
        try {
            let repliedMessage = await discordfunctions.GetMessage(
                client,
